# Generated by Django 4.0.1 on 2022-03-07 12:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waranty', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.PositiveBigIntegerField(default=0)),
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Processing', 'Order Processing'), ('On the way', 'On the way'), ('Completed', 'Completed'), ('Order Cancelled', 'Order Cancelled')], max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
